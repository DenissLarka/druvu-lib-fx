...
public record Instrument(
        String symbol, String name, AssetClass assetClass, double price, LocalDate listed, boolean favourite) {
    ...
    public static List<Instrument> demoData() {
        return List.of(
                ...
                new Instrument(
                        "USDJPY", "US Dollar / Japanese Yen", AssetClass.FX, 155.2, LocalDate.of(1971, 8, 16), true),
                new Instrument(
                        "GBPUSD", "British Pound / US Dollar", AssetClass.FX, 1.272, LocalDate.of(1971, 8, 16), false),
                new Instrument(
                        "USDCHF", "US Dollar / Swiss Franc", AssetClass.FX, 0.897, LocalDate.of(1971, 8, 16), false),
                new Instrument(
                        "AUDUSD",
                ...
                new Instrument(
                        "CL.1", "WTI Crude Oil Front Month", AssetClass.ENERGY, 78.2, LocalDate.of(1983, 3, 30), false),
                new Instrument(
                        "CO.1", "Brent Crude Front Month", AssetClass.ENERGY, 82.5, LocalDate.of(1988, 6, 23), false),
                new Instrument(
                        "NG.1", "Henry Hub Natural Gas", AssetClass.ENERGY, 2.87, LocalDate.of(1990, 4, 3), false),
                new Instrument(
                        "SR3Z6", "3M SOFR Future Dec-26", AssetClass.RATES, 95.9, LocalDate.of(2018, 5, 7), true),
